import psycopg2
try:
    connection = psycopg2.connect(database = "staff2", user = "mihirk1", password = "python", host = "127.0.0.1", port = "5432")
...
cursor.execute('''create table mystaff.employees4
...
cursor.execute("insert into mystaff.employees4 (id,first_name,last_name,department,phone,address,salary) \
